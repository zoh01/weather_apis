...
import 'package:weather_forecast_app/features/presentation/screens/marine_screen/widgets/marine_shimmer.dart';
          ...
          Expanded(
            child: Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.waves_outlined, size: MediaQuery.of(context).size.height * .25, color: ZohColors.primaryColor),
                  SizedBox(height: 10),
                  Text(
